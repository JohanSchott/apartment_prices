...
def apartment_into(features, apartment, model=None):
    ...
    if model != None:
        ...
        print('Predicted apartment price at sold date is {:.1f} Msek. Corresponds to {:.1f} ksek/m2.'.format(
        ...
        print('Predicted apartment price now is {:.1f} Msek. Corresponds to {:.1f} ksek/m2.\n'.format(
            price / 10**6, price / (area * 10**3)))
